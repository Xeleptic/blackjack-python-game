...
print("Welcome to Blackjack Offline Gambling For Kids (powered by stake.com).")
print(f"Company message: Our goal is to introduce fun card games to children! "
      f"It's definitely not to get them hooked to gambling while they're young!!!\n")
